    ...
    <div className="min-h-screen flex flex-col bg-[#0a0a0a] text-white">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="absolute inset-0 z-0 pointer-events-auto">
          <iframe
            src="https://my.spline.design/particles-94dfd10cd56037a858e99e0df34bf51a/"
            frameBorder="0"
            width="100%"
            height="100%"
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center space-y-8 select-none">
          ...
          >
            Odkryj na nowo niesamowite emocje. Oryginalne hity, legendarne edycje i epickie kampanie z generacji konsoli, która zdefiniowała nowoczesny gaming.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[1, 2, 3].map((i) => (
                <div key={i} className="h-[450px] rounded-2xl bg-white/5 border border-white/10 animate-pulse" />
              ))}
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative aspect-video w-full overflow-hidden bg-black/40">
                      {/* Generative placeholder fallback */}
                      <Image
